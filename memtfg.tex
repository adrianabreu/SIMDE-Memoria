...
Para ello se han utilizado las últimas tecnologías modernas del mundo tales como Typescript, 
React, Webpack y Sass, permitiendo aprovechar muchas de las mejoras que se han incorporado a 
este campo en los últimos años.

El resultado es una aplicación web que representa de forma visual e interactiva el funcionamiento 
de estas máquinas, posibilitando 
}
